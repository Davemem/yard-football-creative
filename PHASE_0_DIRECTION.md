...
- `assets/YARD.pdf`
- `assets/Logos/LOGO-1_*` through `assets/Logos/LOGO-11_*`
- `assets/yardfc_ball_transparent.png`

### What the PDF Establishes

- The emotional core is backyard football memory, not generic academy marketing.
- The cover sets the strongest baseline composition: muted grey field, oversized circular green mark, handwritten acid-lime lettering, and a short yellow introduction cue.
- The interior pages lean on story, memory, warmth, and belonging before they move into offers or program types.
- Quotes, founder backstory, and simple headline blocks matter more than dense interface chrome.
- The visual rhythm is poster-like: full-page statements, large breathing room, and a clear hero focal point.
